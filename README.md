...
With a JSON file:
`python -m open_samus_returns_rando --input-path path/to/samus-returns/file.3ds --output-path absolute/path/to/the/output/mod --input-json path/to/patcher-config.json`
