...
def _reserves_per_tank(tunables: Bmtun, configuration: dict):
    ...
    amiibo["fLifeTankSize"]["value"] = configuration["fLifeTankSize"]
    amiibo["fSETankSize"]["value"] = configuration["fSETankSize"]
    amiibo["fMissileTankSize"]["value"] = configuration["fMissileTankSize"]
    amiibo["fSuperMissileTankSize"]["value"] = configuration["fSuperMissileTankSize"]
