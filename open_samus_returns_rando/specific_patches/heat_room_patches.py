...
from open_samus_returns_rando.temp_helper import add_actor_to_entity_groups, insert_into_sub_area
...
def _patch_area_3b(editor: PatcherEditor):
    ...
    insert_into_sub_area(group_cc36, "TG_Heat_003")
...
def _patch_area_3c(editor: PatcherEditor):
    ...
    insert_into_sub_area(group_cc22, "TG_Heat_003")
    insert_into_sub_area(group_cc26, "TG_Heat_003")
...
def _patch_area_5_2(editor: PatcherEditor):
    ...
    add_actor_to_entity_groups(scenario_5, "collision_camera_009", "TG_Heat_033", True)
    add_actor_to_entity_groups(scenario_5, "collision_camera_015", "TG_Heat_033", True)
    add_actor_to_entity_groups(scenario_5, "collision_camera_017", "TG_Heat_033", True)
